...
using namespace std;
	...
	void Grid::draw(const mat4& view, const mat4& light_view, const mat4& projection, const mat4& light_projection, int mode){
		glUseProgram(_pid);
		glBindVertexArray(_vao);
		...
		glUniform1i(glGetUniformLocation(_pid, "tex_shadow"), 2);
