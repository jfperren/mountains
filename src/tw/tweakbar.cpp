...
void initAntTwBar(AppParams* app_params) {
	...
	TwAddVarCB(bar, "shading_shadow_enable", TW_TYPE_BOOL8, setBoolParamCallback, getBoolParamCallback, &shading_params->shadow_enable, " group=Shading");
	TwAddVarCB(bar, "shading_shadow_intensity", TW_TYPE_FLOAT, setFloatParamCallback, getFloatParamCallback, &shading_params->shadow_intensity, " group=Shading step=0.05 min=0 max=1");
